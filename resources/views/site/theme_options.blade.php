...
<div id="theme-options">
    ...
    <div class="title">
        ...
        <p>Choose a combination of predefined colors And layouts here.</p>
    </div>
    <span>SKINS VERSION</span>
    <ul class="layout-style">
        <li class="light active"><a href="?theme=light" title="Light Skin">SKIN LIGHT</a></li>
        <li class="dark"><a  href="?theme=dark" title="Dark Skin">SKIN DARK</a></li>
    </ul>
