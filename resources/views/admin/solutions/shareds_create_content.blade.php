...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> {{ (isset($shared->id)) ? 'Update' : 'Create' }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form action="{{(isset($shared->id)) ? route('shareds.update', ['shareds' => $shared->id]) : route('shareds.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" type="text" id="title" name="title" placeholder="Заголовок материала"
                                   value="{{(isset($shared->title)) ? $shared->title : old('title')}}">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" type="text" id="description" name="description" placeholder="Подзаголовок"
                                   value="{{(isset($shared->description)) ? $shared->description : old('description')}}">
                        </div>

                        <div class="form-group col-md-12">
                            <label for="text"><small>Текст</small></label>
                            <textarea class="form-control" name="text" id="text" placeholder="Текст"
                                      rows="4">{{(isset($shared->text)) ? $shared->text : old('text')}}</textarea>
                        </div>

                        @if(isset($shared->id) && (mb_strlen($shared->img) != 0 ))
                            <div class="form-group col-md-12">
                                <label for="old_img"><small>Старое изображение</small></label>
                                <div><img id="old_img" src="{{asset('mhost/img/servers/'.$shared->img)}}" width="200" height="80" alt="&nbsp;"></div>
                            </div>
                        @endif
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ route('shareds.index') }}" class="btn btn-warning"> <i class="fa fa-undo" aria-hidden="true"></i> Отмена </a>
                    </div>
                </form>
