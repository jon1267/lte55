...
// -------------------------------------------------------------------------------------------------------------------------------
  ...
  $(document).ready(function($) {
	...
	function interface(){
	    ...
	    // Skin Color value
	    var skin_color = "blue"; 	// red (default), green ,yellow,purple,blue, orange, purple, pink, cocoa, custom 
	    ...
	    $(".skin_version").attr("href", "mhost/css/" + skin_version + ".css");
	    $(".skin_color").attr("href", "mhost/css/skins/"+ skin_color + "/" + skin_color + ".css");
	...
	$(".light").click(function(){
	   	$(".skin_version").attr("href", "mhost/css/style.css");
	    return false;
	});
	$(".dark").click(function(){
	    $(".skin_version").attr("href", "mhost/css/style-dark.css");
	    return false;
	});

    // Color changer
    $(".red").click(function(){
	   	$(".skin_color").attr("href", "mhost/css/skins/red/red.css");
	    return false;
	});
	$(".blue").click(function(){
	    $(".skin_color").attr("href", "mhost/css/skins/blue/blue.css");
	    return false;
	});
	$(".yellow").click(function(){
	    $(".skin_color").attr("href", "mhost/css/skins/yellow/yellow.css");
	    return false;
	});
	$(".green").click(function(){
	    $(".skin_color").attr("href", "mhost/css/skins/green/green.css");
	    return false;
	});
	$(".orange").click(function(){
    	$(".skin_color").attr("href", "mhost/css/skins/orange/orange.css");
    	return false;
	});
	$(".purple").click(function(){
	    $(".skin_color").attr("href", "mhost/css/skins/purple/purple.css");
	    return false;
	});
	$(".pink").click(function(){
	    $(".skin_color").attr("href", "mhost/css/skins/pink/pink.css");
	    return false;
	});
	$(".cocoa").click(function(){
        $(".skin_color").attr("href", "mhost/css/skins/cocoa/cocoa.css");
        return false;
   	});
 });
